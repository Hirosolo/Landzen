...
export default function Home() {
  return (
    <div>
      ...
      {/*search and filter */}
      <div className="flex-wrap gap-3  pt-5">

        <div className="flex">
          <div className="ml-8 pl-2 flex items-center border rounded-md pr-3 w-124 border border-gray-300 rounded rounded-md mx-3">
            ...
            <input type="text" placeholder="Search" 
                  className="ml-2 w-full outline-none h-8 text-sm text-gray-700 placeholder-gray-400"/>
          </div>

          <select className="border border-gray-300 rounded-md px-3 h-8 text-sm text-gray-700">
        ...
        <div className="ml-8 mt-3 space-x-2">
          <select className="border border-gray-300 rounded-full px-4 py-0 h-8 text-sm text-gray-700">
