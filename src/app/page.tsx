    ...
    <main className="min-h-screen bg-beige-100 text-gray-900">
      ...
      <section className="px-6 sm:px-12 py-16 flex flex-col lg:flex-row items-center justify-between gap-12 bg-darkGreen">
        ...
        <div className="flex-1 space-y-6">
          ...
          <button onClick={()=>{window.location.href="/marketPlace"}} className="px-6 py-3 bg-beige-100 rounded-lg font-medium shadow hover:bg-beige-300 text-black font-semibold">
            View projects →
          </button>
        </div>
